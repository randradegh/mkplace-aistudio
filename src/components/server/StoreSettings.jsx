...
function StoreSettings() {
  console.log('StoreSettings component rendered!');
    ...
    return (
        <div className="min-h-screen py-8 flex items-center justify-center bg-orange-100">
            <div className="w-full max-w-2xl bg-white shadow-2xl rounded-lg p-8 flex flex-col items-center">
                <header className="mb-8 text-center">
                    ...
                    <p className="text-gray-600 text-lg">
                        Aquí puedes configurar la información que se mostrará en la página principal de la tienda.
                        <br/>
                        Ingresa el nombre de la tienda, el texto de bienvenida y su ciudad y país.
                    </p>
                </header>
                <div className='rounded p-8 border border-gray-300  md:mx-8 lg:mx-16 xl:mx-32 2xl:mx-64 bg-blue-100'>
